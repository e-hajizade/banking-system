...
@Service
public class WithdrawTransaction implements TransactionStrategy<AccountTransactionRequestDto> {

	private final BankAccountRepository accountRepository;

	public WithdrawTransaction(BankAccountRepository accountRepository) {
	...
	public void execute(AccountTransactionRequestDto transactionDto) {
		...
		validate(bankAccount, transactionDto);
	...
	public void register() {
		TransactionStrategyFactory.addTransactionStrategy(TransactionType.WITHDRAW, this);
	}

	private void validate(BankAccount fromAccount, AccountTransactionRequestDto transactionDto) {
